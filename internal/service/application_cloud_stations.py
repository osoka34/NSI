...
class ApplicationCloudStationService(object):
    ...
    def get_cloud_station_by_id(self, in_id: int) -> JSONResponse:
        try:
            ...
            return JSONResponse(status_code=status.HTTP_200_OK, content=cloud_station_dto)
    ...
    def get_all_cloud_station(self) -> JSONResponse:
        try:
    ...
    def add_cloud_station(self, cloud_station: CloudStationDto) -> JSONResponse:
        try:
            ...
            return JSONResponse(status_code=status.HTTP_200_OK, content=cloud_station)
        except Exception as e:
